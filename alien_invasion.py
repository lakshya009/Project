...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Creating an instance for storing statics and a scoreboard
    ...
    def _create_fleet(self):
        ...
        # Spacing between each alien is equal to the width of one width.
        alien = Alien(self)
    ...
    def _create_alien(self, alien_number, row_number):
        """Create an alien and put it in place."""
    ...
    def _update_aliens(self):
        ...
        Check if the fleet is at an edge,
          then update the paositions of the all aliens in the fleet.
        """
        ...
        # Checking Aliens hitting the bottom
